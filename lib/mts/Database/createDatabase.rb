...
client.query("CREATE TABLE IF NOT EXISTS texts_Portal_wifi (TextID INT NOT NULL, organizationID INT NOT NULL, textPage VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci)", :cast => false)
